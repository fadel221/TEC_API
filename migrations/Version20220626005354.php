 ...
 */
final class Version20220626005354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD article_id INT NOT NULL, ADD file LONGBLOB NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image DROP article_id, DROP file');
    }
}
